...
<body>
    ...
    <script>
        ...
        async function animationWriter(content, element, callback) {
            ...
            const typingEffect = async () => {
                if (i < content.length) {
                    ...
                    i++;
                    await sleep(2); // Mengatur kecepatan pengetikan (dalam milidetik)
                    typingEffect();
                } else {
        ...
        function sendMessage() {
            ...
            fetch('http://10.107.195.96:5000/imagechat', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    animationWriter(data.summary, systemMessageContent, scrollToBottom); // Menciptakan efek pengetikan pada pesan sistem
                })
                .catch(error => {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            selectElement.addEventListener('change', function() {
                ...
                if (selectedOption === 'AI Text') {
                    window.location.href = 'http://10.107.195.96/app-chat';
                }
            });
        });
    </script>
